...
class  mapletest06 extends JFrame implements KeyListener{
	int huntf=0;
	int tmpr=0;
	int tmpl=0;
	int rightw=0;
	...
	double maxhunteng=hppre*4;
	double hunt;
	double hunteng=maxhunteng;
	 Timer m_timer01=new Timer();
	...
	int skill02damge=30;
	int skill03damge=50;
	int skill04damge=100;
	
	int monsterhp01=200;
	int monsterhp02=700;
	int boss=2000;
   
	int monsterdamge01=10;
	int monsterdamge02=100;
	int bossdamage=500;
	int bossskilldamage=2000;
    
	int monsterhuneng01=500;
    int monsterhuneng02=1000;
    int monsterhuneng03=10000;
    
	double monsterx01=500;
	int monstery;
...
//	private mapletest02 mp2=new mapletest02();
	...
	Image[] bossmonster=new Image[24];
	...
	Image[] monster01_level01_move_left=new Image[4];
	Image[] monster01_level02_move_left=new Image[4];
	
	Image[] monster02_level01_move_left=new Image[3];
	Image[] monster02_level02_move_left=new Image[4];
	
	Image[] monster03_boss_move_left=new Image[5];
	Image[] monster03_boss_attack_left=new Image[4];
	Image[] monster03_boss_die_left=new Image[3];
	Image[] monster_skill=new Image[27];
...
mapletest06(int j, String st,int mp1,int hp1,int x1,int y1,int movestaus1,int level1,double hunt1 ){
	...
	hunt=hunt1;
	 x=x1;
	 y=y1;
	 moveStatus=movestaus1;
    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    
	this.setTitle("maplemade5");	
	...
	jbuttontest();
	if(keyUp==false&&x>70){
	frame06.schedule(frame06_1, 1,100);
	}
	
	}
private Timer frame06=new Timer();

private TimerTask frame06_1=new TimerTask(){
...
public void keyPressed(KeyEvent e){
	...
	case KeyEvent.VK_UP:
		...
		if(x<=70){
			...
			this.dispose();
			this.remove(this);
			mapletest04 mp4 = new mapletest04(c, str,mp,hp,800,y,2,level,hunt);
		...
		/*if(x==800){
			dispose();
	     add(new mapletest05(c, str,mp,hp,level));
		}*/
		break;
...
public void jbuttontest(){
	...
	public void paint (Graphics g){
		...
		Image img = Toolkit.getDefaultToolkit().getImage("map_warrior.png");//배경이미지 삽입 
		
		Image img01 = Toolkit.getDefaultToolkit().getImage("statebar.png");//배경이미지 삽입 
		g.drawImage(img, 0, 45, 880, 580,this);// 이미지 수정
		...
		if(hunt>=113){
		 ...
		 if(monsterhp01==0&&huntf==0&&level==8&&level01<1){
			 hunt=hunt+113;
			 huntf=1;
			 
		 }
		 else if(monsterhp01==0&&huntf==0&&level==9&&level01<1){
			 hunt=hunt+50;
			 huntf=1;
			 
		 }
		 else if(monsterhp01==0&&huntf==0&&level==10&&level01<1){
			 hunt=hunt+30;
			 huntf=1;
			 
		 }
		 else if(monsterhp01==0&&huntf==0&&level01>=1){
			 hunt=hunt+30;
			 huntf=1;
			 
		 }
		 else if(monsterhp01==0&&huntf==0&&level>=1&&level01>=1){
			 hunt=hunt+5;
			 huntf=1;
		...
		//Font drawFont01= new Font("level", Font.BOLD, 14);
		int []leveldata=new int[100];
		Timer leveltime=new Timer();

		TimerTask leveling=new TimerTask(){
		...
		if(hunt>=113){
		leveltime.schedule(leveling, 0,100);
		}	
		leveldata[0]=level;
		leveldata[1]=level01;
		leveldata[2]=level02;
		...
		Font drawFont02= new Font("str", Font.BOLD, 14);
		g.setFont(drawFont02);
		g.setColor(Color.WHITE);
		...
		// g.drawImage(portal[0], 800, 500, 80, 100,this);// 이미지 수정
		 g.drawImage(portal[0], 50, 500, 80, 100,this);
		 
	

		 
	      
		 bossmonster[0]= Toolkit.getDefaultToolkit().getImage("monster//boss_01.png");
		 bossmonster[1]= Toolkit.getDefaultToolkit().getImage("monster//boss_02.png");
		 bossmonster[2]= Toolkit.getDefaultToolkit().getImage("monster//boss_03.png");
		 bossmonster[3]= Toolkit.getDefaultToolkit().getImage("monster//boss_04.png");
		 bossmonster[4]= Toolkit.getDefaultToolkit().getImage("monster//boss_05.png");
		 bossmonster[5]= Toolkit.getDefaultToolkit().getImage("monster//boss_06.png");
		 bossmonster[6]= Toolkit.getDefaultToolkit().getImage("monster//boss_07.png");
		 bossmonster[7]= Toolkit.getDefaultToolkit().getImage("monster//boss_08.png");
		 bossmonster[8]= Toolkit.getDefaultToolkit().getImage("monster//boss_09.png");
		 bossmonster[9]= Toolkit.getDefaultToolkit().getImage("monster//boss_10.png");
		 bossmonster[10]= Toolkit.getDefaultToolkit().getImage("monster//boss_11.png");
		 bossmonster[11]= Toolkit.getDefaultToolkit().getImage("monster//boss_12.png");
		 bossmonster[12]= Toolkit.getDefaultToolkit().getImage("monster//boss_13.png");
		 bossmonster[13]= Toolkit.getDefaultToolkit().getImage("monster//boss_14.png");
		 bossmonster[14]= Toolkit.getDefaultToolkit().getImage("monster//boss_15.png");
		 bossmonster[15]= Toolkit.getDefaultToolkit().getImage("monster//boss_16.png");
		 bossmonster[16]= Toolkit.getDefaultToolkit().getImage("monster//boss_17.png");
		 bossmonster[17]= Toolkit.getDefaultToolkit().getImage("monster//boss_18.png");
		 bossmonster[18]= Toolkit.getDefaultToolkit().getImage("monster//boss_19.png");
		 bossmonster[19]= Toolkit.getDefaultToolkit().getImage("monster//boss_20.png");
		 bossmonster[20]= Toolkit.getDefaultToolkit().getImage("monster//boss_21.png");
		 bossmonster[21]= Toolkit.getDefaultToolkit().getImage("monster//boss_22.png");
		 bossmonster[22]= Toolkit.getDefaultToolkit().getImage("monster//boss_23.png");
		 bossmonster[23]= Toolkit.getDefaultToolkit().getImage("monster//boss_24.png");
		  TimerTask task01=new TimerTask(){
			...
			if(monsterhp01>0){
			m_timer01.schedule(task01, 100,100000);
			}
			...
			if(moveStatus==1||moveStatus==0){
				if(monsterhp01<=0){
				 ...
				 if(attackx+65>monsterx01&&attackx<monsterx01&&Attack==true){
					
					 
					 
					 if(monsterhp01>attackdamge){
						 monsterhp01=monsterhp01-attackdamge;
					 }
					 else if(monsterhp01<=attackdamge){
						 monsterhp01=0;
					 }
				       }
			 else if(attackx+80>monsterx01&&attackx<monsterx01&&Skill01==true){
					
					 if(monsterhp01>skill01damge){
					 monsterhp01=monsterhp01-skill01damge;}
					 if(monsterhp01<=skill01damge){
						 monsterhp01=0;
					 }
				       }
			 else if(attackx+110>monsterx01&&attackx<monsterx01&&Skill02==true){
				
				 if(monsterhp01>skill02damge){
				 monsterhp01=monsterhp01-skill02damge;}
				 else if(monsterhp01<=skill02damge){
					 monsterhp01=0;
				 }
			       }
			 else if(750>monsterx01&&80<monsterx01&&Skill03==true){
			//	 monsterx01=monsterx01+0.1;
				 if(monsterhp01>skill03damge){
				 monsterhp01=monsterhp01-skill03damge;}
				 else if(monsterhp01<=skill03damge){
					 monsterhp01=0;
				 }
			       }
			 else if(attackx+200>monsterx01&&attackx<monsterx01&&Skill04==true){
				
				 if(monsterhp01>skill04damge){
				 monsterhp01=monsterhp01-skill04damge;}
				 else if(monsterhp01<=skill04damge){
					 monsterhp01=0;
				 }
			       }
				}
				else if(c==1){
					 if(attackx+100>monsterx01&&attackx<monsterx01&&Attack==true){
				 ...
				 else if(attackx+200>monsterx01&&attackx<monsterx01&&Skill01==true){
					
					 if(monsterhp01>skill01damge){
						 monsterhp01=monsterhp01-skill01damge;}
					 else if(monsterhp01<=skill01damge){
							 monsterhp01=0;
						 }
					       }
				 else if(attackx+200>monsterx01&&attackx<monsterx01&&Skill02==true){
				 ...
				 else if(attackx+250>monsterx01&&attackx<monsterx01&&Skill03==true){
				 ...
				 else if(attackx+320>monsterx01&&attackx<monsterx01&&Skill04==true){
					 ...
					 if(attackx+60>monsterx01&&attackx<monsterx01&&Attack==true){
				 ...
				 else if(attackx+120>monsterx01&&attackx<monsterx01&&Skill01==true){
					// monsterx01=monsterx01+50;
					    if(monsterhp01>skill01damge){
				 ...
				 else if(attackx+120>monsterx01&&attackx<monsterx01&&Skill02==true){
					// monsterx01=monsterx01+50;
					 if(monsterhp01>skill02damge){
					 monsterhp01=monsterhp01-skill02damge;}
					 else if(monsterhp01<=skill02damge){
				 ...
				 else if(attackx+220>monsterx01&&attackx<monsterx01&&Skill03==true){
					// monsterx01=monsterx01+30;
					 if(monsterhp01>skill03damge){
					 monsterhp01=monsterhp01-skill03damge;}
					 else if(monsterhp01<=skill03damge){
						 monsterhp01=0;
				 ...
				 else if(750>monsterx01&&80<monsterx01&&Skill04==true){
					// monsterx01=monsterx01+1;
					 if(monsterhp01>skill04damge){
					 monsterhp01=monsterhp01-skill04damge;}
					 else if(monsterhp01<=skill04damge){
						 monsterhp01=0;
				 ...
				 else if(attackx+70>monsterx01&&attackx<monsterx01&&Skill01==true){
						// monsterx01=monsterx01+50;
						 if(monsterhp01>skill01damge){
						 monsterhp01=monsterhp01-skill01damge;}
						 else if(monsterhp01<=skill01damge){
				 ...
				 else if(attackx+80>monsterx01&&attackx<monsterx01&&Skill02==true){
					// monsterx01=monsterx01+50;
					 if(monsterhp01>skill02damge){
					 monsterhp01=monsterhp01-skill02damge;}
					 else if(monsterhp01<=skill02damge){
				 ...
				 else if(attackx+240>monsterx01&&attackx<monsterx01&&Skill03==true){
					// monsterx01=monsterx01+30;
					 if(monsterhp01>skill03damge){
					 monsterhp01=monsterhp01-skill03damge;}
					 else if(monsterhp01<=skill03damge){
				...
				if(monsterhp01>0){
					 if(x<=monsterx01&&x+30>=monsterx01&&hp>0){
		    				x=x-50;
		    				if(hp<=monsterdamge01&&hp<=0){
		    					hp=0;
		    				...
		    				hp=hp-monsterdamge01;
		    			}
						g.drawImage( bossmonster[bossmove/30], (int)monsterx01, 290, 300, 300,this);}
		...
		//	 monsterx01=monsterx01-1;
			...
			/* g.drawImage(monster01_level01_move_left[0], (int)monsterx, 560, 35, 35,this); 
			 g.drawImage(monster01_level01_move_left[1], (int)monsterx-100, 560, 35, 35,this); 
			 g.drawImage(monster01_level01_move_left[2], (int)monsterx-200, 560, 35, 35,this); 
			 g.drawImage(monster01_level01_move_left[3], (int)monsterx-300, 560, 35, 35,this);*/  
	   ...
	   if(a==0){
		...
		//	walkiconleft[0]= Toolkit.getDefaultToolkit().getImage("war_walk//walk01_left.png");
			...
			walkiconleft[3]= Toolkit.getDefaultToolkit().getImage("war_walk//walk05_left.png");
				...
				g.drawImage(walkiconleft[leftw/5], attackx, y,  w, h,this);
				}
			...
			if(char_jump/4>2){
				...
				g.drawImage(cha_attack_war[attack/6], attackx, y,  w, h,this);
				requestFocus();
			}
				...
				g.drawImage(cha_attack_war_right[attack/6], attackx, y,  w, h,this);
				requestFocus();
			}
...
if(char_jump/4>2){
	...
	if(char_jump/4>2){
		...
		g.drawImage(war_jump[char_jump/4], charx, y,  charwidth, 65,this);
				...
				g.drawImage(cha_attack_arr[attack/5], attackx, y,  w, h,this);
			...
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+50, skillsizey,  skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+80, skillsizey,  skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+110, skillsizey,  skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+140, skillsizey,  skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+170, skillsizey,  skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+200, skillsizey, skillsizew,skillsizeh,this);
			g.drawImage(cha_skill02_arr_right[skill02/2], skillsizex+230, skillsizey,  skillsizew,skillsizeh,this);
		 ...
		 monster_skill[0]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//00.png");
		 monster_skill[1]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//01.png");
		 monster_skill[2]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//02.png");
		 monster_skill[3]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//03.png");
		 monster_skill[4]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//04.png");
		 monster_skill[5]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//05.png");
		 monster_skill[6]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//06.png");
		 monster_skill[7]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//07.png");
		 monster_skill[8]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//08.png");
		 monster_skill[9]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//09.png");
		 monster_skill[10]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//10.png");
		 monster_skill[11]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//11.png");
		 monster_skill[12]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//12.png");
		 monster_skill[13]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//13.png");
		 monster_skill[14]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//14.png");
		 monster_skill[15]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//15.png");
		 monster_skill[16]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//16.png");
		 monster_skill[17]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//17.png");
		 monster_skill[18]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//18.png");
		 monster_skill[19]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//19.png");
		 monster_skill[20]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//20.png");
		 monster_skill[21]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//21.png");
		 monster_skill[22]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//22.png");
		 monster_skill[23]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//23.png");
		 monster_skill[24]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//24.png");
		 monster_skill[25]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//25.png");
		 monster_skill[26]= Toolkit.getDefaultToolkit().getImage("monster//skilltype01//26.png");
		   Timer bossskilltile = new Timer();  
			 
			  
			   TimerTask bossattack01=new TimerTask(){
			        	public void run(){
			        ...
			        if(boskil/50>26){
			        	...
			        	bossskillx=100;}
			        	else if(bossskillx==100){
			        		
			        		bossskillx=300;
			        	}
		    
				       // bossattack01.cancel();	 
				      //  bossskilltile.cancel();
				        boskil=0;
	        		//boskil=27;
	        		     }
			        else if(boskil/50<26){
			        	if(bossskillx==100&&190<=x&&x<=205){
			        		x=x-30;
			        		hp=hp-50;
			        	}
			        	else if(bossskillx==100&&205<x&&x<220){
			        		x=x+30;
			        		hp=hp-50;
			        	}
                        else if(bossskillx==300&&380<x&&x<=400){
                        	x=x-30;
                        	hp=hp-50;
			        	}
                        else if(bossskillx==300&&400<x&&x<415){
                        	x=x+30;
                        	hp=hp-50;
			        	}
                        else if(hp<=0){
			        	...
			        	g.drawImage(monster_skill[boskil/50], bossskillx, 300, 300, 300,this);
			        bossskilltile.schedule(bossattack01,5000);
			        }
